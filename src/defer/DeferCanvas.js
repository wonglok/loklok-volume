...
import { DeferPipeline } from "./DeferPipeline";

export const DeferCanvas = () => {
  ...
  useEffect(() => {
    ...
    let mods = [
      new Base(mini),
      new DeferPipeline(mini),
      new SceneControls(mini),
    ];

    mini.get("SceneControls").then((SceneControls) => {
      // SceneControls.controls.enableRotate = false;
      //
      // window.addEventListener("touchstart", () => {
      //   SceneControls.controls.enabled = false;
      // });
    });
    //, new SceneControls(mini)
